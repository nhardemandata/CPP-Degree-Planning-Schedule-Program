...
#ifndef CySec_H // define, if not already defined
#define CySec_H
...
class CySec { // class definition
    ...
    public:
        CySec(); // default constructor
        ifstream CySTranscriptsFiles; // open Transcripts file
        ofstream CySStudentsSchedule; // write selected schedule to file
