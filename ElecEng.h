// Electrical Engineer Class
#ifndef ElecEng_H // define, if not already defined
#define ElecEng_H
...
class ElecEng { // class definition
    ...
    public:
        ElecEng(); // default constructor
        ifstream EETranscriptsFiles; // open Transcripts file
        ofstream EEStudentsSchedule; // write selected schedule to file
