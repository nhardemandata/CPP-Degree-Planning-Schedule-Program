...
#ifndef ComputerScience_H // define, if not already defined
...
class CompSci { // class definition
    ...
    public:
        CompSci(); // default constructor
        ifstream CSTranscriptsFiles; // open Transcripts file
        ofstream CSStudentsSchedule; // write selected schedule to file
